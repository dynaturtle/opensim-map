...
//**************************************
//2010/11/6，栋修改的，把下面的话注释掉了

//#include "lldarray.h"
#include "../llcommon/lluuid.h"
#include "../llcommon/v4color.h"
//**************************************

//#include "vmath.h"
#include "../llcommon/v2math.h"
#include "../llcommon/v3math.h"
#include "../llcommon/llquaternion.h"
...
const F32 CUT_QUANTA    = 0.01; //0.00002f;
...
class __declspec(dllexport) LLProfileParams
{
public:
	LLProfileParams()
...
class __declspec(dllexport) LLPathParams
{
public:
	LLPathParams()
		:
...
class __declspec(dllexport) LLVolumeParams
{
public:
	LLVolumeParams()
...
class __declspec(dllexport) LLProfile
{
public:
	LLProfile()
		: mOpen(FALSE),
...
class __declspec(dllexport) LLPath
{
public:
	struct PathPt
	{
...
class __declspec(dllexport) LLVolumeFace
{
public:
	LLVolumeFace() : 
		mID(0),
...
class __declspec(dllexport) LLVolume : public LLRefCount
{
	//friend class LLVolumeLODGroup; //这句只是为了让类LLVolumeLODGroup能访问LLVolume类中的私有变量，因为用不到LLVolumeLODGroup，删
